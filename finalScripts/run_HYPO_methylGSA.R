...
print("Processed hypomethylated CpGs:")
print(head(hypo_cpgs))
print(paste("Dimensions of processed hypo_cpgs:", dim(hypo_cpgs)))
...
print("hypo CpGs with chromosomal regions:")
print(head(hypo_cpgs))
print(paste("Dimensions of hypo_cpgs with chromosomal regions:", dim(hypo_cpgs)))


# Retrieve gene annotations for hypomethylated CpGs
...
print("hypo annotations:")
print(head(hypo_annotations))
print(paste("Dimensions of hypo_annotations:", dim(hypo_annotations)))
...
print("Filtered hypo annotations:")
print(head(hypo_annotations))
print(paste("Dimensions of filtered hypo_annotations:", dim(hypo_annotations)))

# Display the first few rows to confirm
head(hypo_annotations)

# Assume hypo_cpgs has a 'cpg_id' column with the format "chr_start_end"
...
print("hypo CpGs with extracted chr, start, and end:")
print(head(hypo_cpgs))
print(paste("Dimensions of hypo_cpgs with extracted chr, start, and end:", dim(hypo_cpgs)))


# Parse 'chromosomal_region' in hypo_annotations to chr, start, and end
hypo_annotations <- hypo_annotations %>%
  mutate(
...
print("Parsed hypo annotations:")
print(head(hypo_annotations))
print(paste("Dimensions of parsed hypo_annotations:", dim(hypo_annotations)))
