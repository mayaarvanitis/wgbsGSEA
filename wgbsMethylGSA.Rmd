...
custom_annotation_simplified <- merge(custom_annotation_simplified, cpg_genes, by.x = c("Chromosome", "Start", "End"), by.y = c("chromosome_name", "start_position", "end_position"), all.x = TRUE)
