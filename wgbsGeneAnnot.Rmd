...
valid_cpg_ids <- FullAnnot2$cpg_id
...
conversion_table <- getBM(
    attributes = c("entrezgene_id", "ensembl_gene_id"),  # Attributes to retrieve
    filters = "entrezgene_id",                           # Filter on Entrez IDs
    values = hallmarks_list$entrez_id,                   # Entrez IDs to convert
    mart = ensembl                                       # The Biomart connection
)
```
